...
@Component("getApiRestGrabacionEnvioOficProcedure")
public class GetApiRestGrabacionEnvioOficProcedure extends ChxStoredProcedure {

	/** LOG */
	private static final Log LOG = LogFactory.getLog(GetApiRestGrabacionEnvioOficProcedure.class);
	/** PROCEDURE_NAME */
	private static final String PROCEDURE_NAME = Constants.PROCEDURE_NAME_GRABAR_ENVIO_OFICINAS;
	/** PACKAGE_NAME */
	...
	@Autowired
	public GetApiRestGrabacionEnvioOficProcedure(DataSource dataSource) {
		...
		declareParameter(new SqlParameter("codDirecDestino", OracleTypes.VARCHAR));
	...
	public GrabacionEnvioResponseJSON execute(GrabacionEnvioJSON ge)
		...
		parametros.put("codDirecDestino", ge.getCodDirecDestino());
